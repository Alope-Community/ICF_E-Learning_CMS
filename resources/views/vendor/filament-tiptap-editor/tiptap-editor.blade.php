...
>
    <div @class([
        'tiptap-editor border rounded-md relative bg-white shadow-sm text-gray-700',
        ...
        <div
            wire:ignore
            class="relative z-0 tiptap-wrapper bg-white rounded-md"
        ...
        >
            ...
            @if (! $isDisabled)
                ...
                <div class="tiptap-toolbar border-b border-gray-200 bg-gray-50 divide-x divide-gray-300 rounded-t-md z-[1] relative flex flex-col md:flex-row">
